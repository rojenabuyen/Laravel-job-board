    ...
    @if('textarea' != $type)
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" 
                ...
                stroke="currentColor" class="w-4 h-4text-slate-100">
        ...
        @class([
            'w-full bg-[#363D46] rounded-md border-0 py-1.5 px-2.5 text-sm ring-1 text-slate-200 placeholder:text-slate-100 focus:ring-2',
            'pr-8' => $formRef,
